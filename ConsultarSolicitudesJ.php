            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="ConsultarSolicitudesJ.php">Consultar Solicitud</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ViewConsultarReportes.php">Consultar Reporte</a>
                    </div>
                </div>
            </li>
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        while($datos=$sql->fetch_object()){
                                                            ...
                                                            echo "<td><a href='ViewAsignarEmpleado.php?id=" . $datos->id_solicitud . "' class='btn btn-warning btn-sm mr-2'><i class='fa-solid fa-helmet-safety'></i></a></td>";
