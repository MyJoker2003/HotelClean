                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $myconsulta = "SELECT * FROM solicitud";
                                                        ...
                                                        while($datos=$sql->fetch_object()){
                                                            ...
                                                            echo "<td><a href='ViewFinalizarSolicitud.php?id=" . $datos->id_solicitud . "' class='btn btn-warning btn-sm mr-2'><i class='fa-solid fa-check-to-slot'></i></a></td>";
...
//--->                                                    // Agregar 10 filas manualmente
                                                    /*for ($i = 1; $i <= 10; $i++) {
                                                        echo "<tr>";
                                                        echo "<td>" . $i . "</td>";
                                                        echo "<td>Área " . $i . "</td>";
                                                        echo "<td>2024-04-18</td>";
                                                        echo "<td>12:00 PM</td>";
                                                        echo "<td>Pendiente</td>";
                                                        echo "<td>";
                                                        echo "<a href='#' class='btn btn-warning btn-sm mr-2'><i class='fa-solid fa-helmet-safety'></i></a>";
                                                        echo "</td>";
                                                        echo "</tr>";
                                                    }*/
                                                    ?>
