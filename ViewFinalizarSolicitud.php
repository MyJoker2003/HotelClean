            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="buttons.html">Crear Solicitudes</a>
                        <a class="collapse-item" href="cards.html">Consultar Solicitud</a>
                    </div>
                </div>
            </li>
                                        ...
                                        <div>
                                            ...
                                            <form id="formulario-limpieza">
                                                ...
                                                <!--<div class="form-group">
                                                    <table class="w-100">
                                                        <tr>
                                                            <td style="width: 60%;"><label for="actividades">Trabajo Asignado:</label></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 20%;">
                                                                <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Password"></td>
                                                            </td>
                                                            <td style="width: 20%;">
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                JOIN nombrecompleto USING(id_empleado)";
