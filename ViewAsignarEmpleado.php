<?php 
    ...
    $myconsulta = "SELECT * FROM solicitud WHERE id_solicitud = $id_sol";
...
<body id="page-top">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="buttons.html">Consultar Solicitud</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="reportesC.php">Ver Reportes</a>
                    </div>
                </div>
            </li>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="container">
                                        <div>
                                            <h5 class="text-center">Solicitud</h5>
                                            <form id="formulario-limpieza">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="id-typeArea" name="id-typeArea" value="<?php echo $tipoArea?>" readonly>
                                                </div>
                                                <!--INPUT AREA/HABITACION-->
                                                <div class="form-group">
                                                    <label for="area">Área/Habitación:</label>
                                                    <input type="text" class="form-control" id="area" name="area" value="<?php echo $areahab->area_habitacion?>" readonly>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="estado" name="estado" value="<?php echo $datos->estado?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <table class="w-100">
                                                        <tr>
                                                ...
                                                <div class="form-group">
                                                    <label for="conserjes">Conserje Asignado:</label>
                                                    <table class="w-100">
                                                        <tr>
                                                            <td style="width: 80%;">
                                                                <select class="form-control" id="conserjes" name="conserjes" required>
                                                                    <?php require_once('getConserjes.php') ?>
                                                                </select>
                                                            </td>
                                                            <td style="width: 20%;">
                                                                <button type="button" class="btn btn-success btn-block" id="agregar-empleado">Agregar</button>
                                                            </td>
                                                        </tr>
                                                        
                                                    </table>
                                                </div>
                                                <ul id="empleados-asignados"></ul>
                                                <div class="form-group">
                                                    <label for="instrucciones">Instrucciones Adicionales:</label>
                                                    <textarea class="form-control" id="instrucciones" name="instrucciones" rows="3" readonly><?php echo $datos->instrucciones ?></textarea>
                                                </div>
    ...
    <script src="empleadocontroller.js" defer></script>
