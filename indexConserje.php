<?php
session_start();
if (!isset($_SESSION['usuario']) || $_SESSION['puesto'] !== 'Conserje') {
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Submenu Consultas:</h6>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="reportesC.php">Nuevo Reporte</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <!--<span class="mr-2 d-none d-lg-inline text-gray-600 small">Juan Carlos Anastasio Salas</span>-->
                            </a>
    ...
    <script>
        // Script adicional para manejar la redirección desde login.js
        $(document).ready(function() {
            // Verificar si se recibió un parámetro de redirección
