            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Consultar Solicitud</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="utilities-color.html">Nuevo Reporte</a>
                    </div>
                </div>
            </li>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">NUEVO REPORTE</h6>
                                </div>
                                <div class="card-body">
                                    <div class="container">
                                        <div>
                                            ...
                                            <form id="formulario-limpieza">
                                                <div class="form-group">
                                                    <input type="text" class="form-control d-none" id="id-conserje" name="id-conserje" value="EMP005" readonly>
                                                </div>
                                                <!--Select: TIPO AREA-->
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="typereport" name="typereport" required>
                                                        <option value="Daño">Daño</option>
                                                        <option value="Robo">Robo</option>
                                                        <option value="Robo">Otro</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    <table class="w-100">
                                                ...
                                                <button type="button" class="btn btn-primary btn-block" id="report-content">Reportar</button>
